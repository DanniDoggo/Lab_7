//anything going to move put in box first
var actorChars = {
  '@': Player,
  'o': Coin,
  'g': Goal
...
function Level(plan) {
  ...
  //can only have one player w/ logic 0 will only return one player
...
Goal.prototype.act = function(step){
  this.wobble += step * goalSpeed;
  var wobblePos = Math.sin(this.wobble) * goalDist;
  this.pos = this.basePos.plus(new Vector (0, wobblePos));
